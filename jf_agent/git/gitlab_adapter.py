                ...
                try:
                    ...
                    for api_pr in tqdm(
                        ...
                        try:
                            ...
                            nrm_commits: List[StandardizedRepository] = [
                                _normalize_commit(
                                    commit,
                                    nrm_repo,
...
def _normalize_project(api_group, redact_names_and_urls: bool) -> StandardizedProject:
...
def _normalize_pr(
    merge_request,
    standardized_commits: List[StandardizedRepository],
    strip_text_content: bool,
    redact_names_and_urls: bool,
    merge_commit,
):
