...
TIME_LIMIT=$(curl -H "Accept: application/json" -H "Content-Type: application/json" -H "Jellyfish-API-Token: $TOKEN" https://app.jellyfish.co/endpoints/agent/time-limit | jq .time_limit_string)
