...
class TestGitLabAdapter(TestCase):
    ...
    def test_get_users(self):
        ...
        for idx, test_user in enumerate(test_users):
            ...
            self.assertEqual(result_user.id, test_user['id'], "resulting user id does not match input")
            self.assertEqual(result_user.login, test_user['username'], "resulting user login does not match input")
            self.assertEqual(result_user.name, test_user['name'], "resulting user name does not match input")
            self.assertEqual(result_user.url, test_user['web_url'], "resulting user url does not match input")
    ...
    def test_get_projects(self):
        ...
        self.assertEqual(resulting_project.id, test_group['id'], "resulting project id does not match input")
        self.assertEqual(resulting_project.login, test_group['id'], "resulting project login does not match input")
        self.assertEqual(resulting_project.name, test_group['name'], "resulting project name does not match input")
    ...
    def test_get_branches(self):
        ...
        self.assertEqual(resulting_branch.name, test_branch['name'], "resulting branch id does not match input")
        self.assertEqual(resulting_branch.sha, test_branch['commit']['id'], "resulting branch id does not match input")
    ...
    def test_get_repos(self):
        ...
        self.assertEqual(resulting_repo.id, test_repo['id'], "resulting repo id does not match input")
        self.assertEqual(resulting_repo.name, test_repo['name'], "resulting repo name does not match input")
        self.assertEqual(resulting_repo.full_name, test_repo['name'], "resulting repo full_name does not match input")
        ...
        self.assertEqual(result_branch.sha, test_branch['commit']['id'], "resulting branch sha does not match input")

        test_group = test_groups[0]
        self.assertEqual(resulting_repo.project.id, test_group['id'], "resulting repo project id does not match input")
        self.assertEqual(resulting_repo.project.name, test_group['name'], "resulting repo project name does not match input")
        self.assertEqual(resulting_repo.project.login, test_group['id'], "resulting repo project login does not match input")
    ...
    def test_get_branch_commits(self):
        ...
        self.assertEqual(result_commit.url, f"{mock_repo_url}/commit/{test_commit['id']}", "resulting commit url does not match input")
        ...
        self.assertEqual(result_commit.repo.name, "test_repo_name", "resulting commit repo name does not match input")

        result_author = result_commit.author
        self.assertEqual(result_author.id, f"{test_commit['author_name']}<{test_commit['author_email']}>", "resulting commit author id does not match input")
        self.assertEqual(result_author.login, test_commit['author_email'], "resulting commit author login does not match input")
        self.assertEqual(result_author.name, test_commit['author_name'], "resulting commit author name does not match input")
        self.assertEqual(result_author.email, test_commit['author_email'], "resulting commit author email does not match input")
    ...
    def test_get_pull_requests(self):
        ...
        self.assertEqual(resulting_pr.created_at, mock_pr.created_at, "resulting pr created_at does not match input")
        self.assertEqual(resulting_pr.updated_at, mock_pr.updated_at, "resulting pr updated_at does not match input")
        self.assertEqual(resulting_pr.merge_date, mock_pr.merged_at, "resulting pr merge_date does not match input")
        self.assertEqual(resulting_pr.closed_date, mock_pr.closed_at, "resulting pr closed_date does not match input")
        ...
        self.assertEqual(resulting_pr.base_branch, mock_pr.target_branch, "resulting pr base_branch does not match input")
        self.assertEqual(resulting_pr.head_branch, mock_pr.source_branch, "resulting pr head_branch does not match input")
